...
function Subscriber_detail(props) {
  let email = (props.info?.email?.split("@")[0].length>6?props.info?.email?.split("@")[0].substr(0,5)+"....@" + props.info?.email?.split("@")[1]:props.info?.email?.split("@")[0].substr(0,3) + "....@" + props.info?.email?.split("@")[1])
  return (
